...
//
//  Source: https://github.com/claviska/Generator
//
...
class Generator {
  ...
  //
  //  $overlay* (string|Generator) - The image to overlay. This can be a filename, a data URI, or
  //    a Generator object.
  ...
  public function overlay($overlay, $anchor = 'center', $opacity = 1, $xOffset = 0, $yOffset = 0) {
    // Load overlay image
    if(!($overlay instanceof Generator)) {
      $overlay = new Generator($overlay);
    }
  ...
  public function text($text, $options, &$boundary = null) {
    ...
    //
    // See: https://github.com/claviska/Generator/issues/165
    //
